...
if __name__ == "__main__":
    ...
    update_state("init")
    sip_session = SIPSession(options.ip, options.extension, options.domain, options.password or os.environ.get("HIKVISION_PASSWORD"), options.username, display_name=options.name)
